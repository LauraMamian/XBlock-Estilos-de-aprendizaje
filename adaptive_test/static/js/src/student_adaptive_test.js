...
function StudentAdaptiveTestXBlock(runtime, element) {
    ...
    function loadBandlerGrinder() {
        ...
        html = `<div id="testContainer" class="card d-flex justify-content-center" >

        <head>
            <meta charset="UTF-8">
            <title>Test de Bandler & Grinder</title>
        ...
        <h1 id="rcorners1">Test de Bandler & Grinder</h1>
      
            <div class="titles">Instrucciones</div><br>
      
            <p>Elije una opcion con la que más te identificad de cada una de las preguntas:</p>
            <br>
      
            <form>
              <div class="pregresp">
                <h4>1. ¿Cuál de las siguientes actividades disfrutas más?</h4><br>
                <input type="radio" name="N1" value="a"> Escuchar música<br>
                <input type="radio" name="N1" value="b"  > Ver películas<br>  
                <input type="radio" name="N1" value="c"> Ver películas<br>  
              </div>
      
              <div class="pregresp">
                <h4>2. ¿Qué programa de televisión prefieres?</h4><br>
                <input type="radio" name="N2" value="a"> Reportajes de descubrimientos y lugares<br>
                <input type="radio" name="N2" value="b"  >Cómico y de entretenimiento<br>  
                <input type="radio" name="N2" value="c">Noticias del mundo<br>  
              </div>
      
              <div class="pregresp">
                <h4>3. Cuando conversas con otra persona, tú:</h4><br>
                <input type="radio" name="N3" value="a"> La escuchas atentamente<br>
                <input type="radio" name="N3" value="b"  > La observas<br>  
                <input type="radio" name="N3" value="c"> Tiendes a tocarla<br>  
              </div>
      
              <div class="pregresp">
                <h4>4. Si pudieras adquirir uno de los siguientes articulos, ¿Cuál elegirías?</h4><br>
                <input type="radio" name="N4" value="a">Un jacuzzi<br>
                <input type="radio" name="N4" value="b"  >Un estéreo<br>  
                <input type="radio" name="N4" value="c">Un televisor<br>  
              </div>
      
              <div class="pregresp">
          <h4>5. ¿Qué prefieres hacer un sábado por la tarde?</h4><br>
          <input type="radio" name="N5" value="a"> Quedarte en casa<br>
          <input type="radio" name="N5" value="b"> Ir a un concierto<br>  
          <input type="radio" name="N5" value="c"> Ir al cine<br>  
</div>

<div class="pregresp">
          <h4>6. ¿Qué tipo de exámenes se te facilitan más?</h4><br>
          <input type="radio" name="N6" value="a"> Examen oral<br>
          <input type="radio" name="N6" value="b"> Examen escrito<br>  
          <input type="radio" name="N6" value="c"> Examen de opción múltiple<br>  
</div>

<div class="pregresp">
          <h4>7. ¿Cómo te orientas más fácilmente?</h4><br>
          <input type="radio" name="N7" value="a"> Mediante el uso de un mapa<br>
          <input type="radio" name="N7" value="b"> Pidiendo indicaciones<br>  
          <input type="radio" name="N7" value="c"> A través de la intuición<br>  
</div>

<div class="pregresp">
          <h4>8. ¿En qué prefieres ocupar tu tiempo en un lugar de descanso?</h4><br>
          <input type="radio" name="N8" value="a"> Pensar<br>
          <input type="radio" name="N8" value="b"> Caminar por los alrededores<br>  
          <input type="radio" name="N8" value="c"> Descansar<br>  
</div>

<div class="pregresp">
          <h4>9. ¿Qué te halaga más?</h4><br>
          <input type="radio" name="N9" value="a"> Que te digan que tienes buen aspecto<br>
          <input type="radio" name="N9" value="b"> Que te digan que tienes un trato muy agradable<br>  
          <input type="radio" name="N9" value="c"> Que te digan que tienes una conversación interesante<br>  
</div>

<div class="pregresp">
          <h4>10.  ¿Cuál de estos ambientes te atrae más?</h4><br>
          <input type="radio" name="N10" value="a"> Uno en el que se sienta un clima agradable<br>
          <input type="radio" name="N10" value="b"> Uno en el que se escuchen las olas del mar<br>  
          <input type="radio" name="N10" value="c"> Uno con una hermosa vista al océano<br>  
</div>

<div class="pregresp">
          <h4>11. ¿De qué manera se te facilita aprender algo?</h4><br>
          <input type="radio" name="N11" value="a"> Repitiendo en voz alta<br>
          <input type="radio" name="N11" value="b"> Escribiéndolo varias veces<br>  
          <input type="radio" name="N11" value="c"> Relacionándolo con algo divertid<br>  
</div>

<div class="pregresp">
          <h4>12. ¿A qué evento preferirías asistir?</h4><br>
          <input type="radio" name="N12" value="a"> A una reunión social<br>
          <input type="radio" name="N12" value="b"> A una exposición de arte<br>  
          <input type="radio" name="N12" value="c"> A una conferencia<br>  
</div>

<div class="pregresp">
          <h4>13.  ¿De qué manera te formas una opinión de otras personas?</h4><br>
          <input type="radio" name="N13" value="a"> Por la sinceridad en su voz<br>
          <input type="radio" name="N13" value="b"> Por la forma de estrecharte la mano<br>  
          <input type="radio" name="N13" value="c"> Por su aspecto<br>  
</div>

<div class="pregresp">
          <h4>14.  ¿Cómo te consideras?</h4><br>
          <input type="radio" name="N14" value="a"> Atlético<br>
          <input type="radio" name="N14" value="b"> Intelectual<br>  
          <input type="radio" name="N14" value="c"> Sociable<br>  
</div>

<div class="pregresp">
          <h4>15. ¿Qué tipo de películas te gustan más?</h4><br>
          <input type="radio" name="N15" value="a"> Clásicas<br>
          <input type="radio" name="N15" value="b"> De acción<br>  
          <input type="radio" name="N15" value="c"> De amor<br>  
</div>

<div class="pregresp">
          <h4>16. ¿Cómo prefieres mantenerte en contacto con otra persona?</h4><br>
          <input type="radio" name="N16" value="a"> Por correo electrónico<br>
          <input type="radio" name="N16" value="b"> Tomando un café juntos<br>  
          <input type="radio" name="N16" value="c"> Por teléfono<br>  
</div>

<div class="pregresp">
          <h4>17.  ¿Cuál de las siguientes frases se identifican más contigo?</h4><br>
          <input type="radio" name="N17" value="a"> Me gusta que mi coche se sienta bien al conducirlo<br>
          <input type="radio" name="N17" value="b"> Percibo hasta el mas ligero ruido que hace mi coche<br>  
          <input type="radio" name="N17" value="c"> Es importante que mi coche esté limpio por fuera y por dentro<br>  
</div>

<div class="pregresp">
          <h4>18.  ¿Cómo prefieres pasar el tiempo con tu pareja?</h4><br>
          <input type="radio" name="N18" value="a"> Conversando<br>
          <input type="radio" name="N18" value="b"> Acariciándose<br>  
          <input type="radio" name="N18" value="c"> Mirando algo juntos<br>  
</div>

<div class="pregresp">
          <h4>19. Si no encuentras las llaves en una bolsa</h4><br>
          <input type="radio" name="N19" value="a"> La buscas mirando<br>
          <input type="radio" name="N19" value="b"> Sacudes la bolsa para oír el ruido<br>  
          <input type="radio" name="N19" value="c"> Buscas al tacto<br>  
</div>

<div class="pregresp">
          <h4>20.  Cuando tratas de recordar algo, ¿cómo lo haces?</h4><br>
          <input type="radio" name="N20" value="a"> A través de imágenes<br>
          <input type="radio" name="N20" value="b"> A través de emociones<br>  
          <input type="radio" name="N20" value="c"> A través de sonidos<br>  
</div>
              <div class="pregresp">
          <h4>21. Si tuvieras dinero, ¿qué harías? </h4><br>
          <input type="radio" name="N21" value="a"> Comprar una casa<br>
          <input type="radio" name="N21" value="b"> Viajar y conocer el mundo<br>  
          <input type="radio" name="N21" value="c"> Adquirir un estudio de grabación<br>  
            </div>

    <div class="pregresp">
            <h4>22. ¿Con qué frase te identificas más?</h4><br>
            <input type="radio" name="N22" value="a"> Reconozco a las personas por su voz<br>
            <input type="radio" name="N22" value="b"> No recuerdo el aspecto de la gente<br>  
            <input type="radio" name="N22" value="c"> Recuerdo el aspecto de alguien, pero no su nombre<br>  
    </div>

    <div class="pregresp">
            <h4>23. Si tuvieras que quedarte en una isla desierta, ¿qué preferirías llevar contigo?</h4><br>
            <input type="radio" name="N23" value="a"> Algunos buenos libros<br>
            <input type="radio" name="N23" value="b"> Un radio portátil de alta frecuencia<br>  
            <input type="radio" name="N23" value="c"> Golosinas y comida enlatada<br>  
    </div>

    <div class="pregresp">
            <h4>24. ¿Cuál de los siguientes entretenimientos prefieres?</h4><br>
            <input type="radio" name="N24" value="a"> Tocar un instrumento musical<br>
            <input type="radio" name="N24" value="b"> Sacar fotografías<br>  
            <input type="radio" name="N24" value="c"> Actividades manuales<br>  
    </div>

    <div class="pregresp">
            <h4>25. ¿Cómo es tu forma de vestir?</h4><br>
            <input type="radio" name="N25" value="a"> Impecable<br>
            <input type="radio" name="N25" value="b"> Informal<br>  
            <input type="radio" name="N25" value="c"> Muy informa<br>  
    </div>

    <div class="pregresp">
            <h4>26. ¿Qué es lo que más te gusta de una fogata nocturna?</h4><br>
            <input type="radio" name="N26" value="a"> El calor del fuego y los bombones asados<br>
            <input type="radio" name="N26" value="b"> El sonido del fuego quemando la leña<br>  
            <input type="radio" name="N26" value="c"> Mirar el fuego y las estrellas<br>  
    </div>

    <div class="pregresp">
            <h4>27. ¿Cómo se te facilita entender algo?</h4><br>
            <input type="radio" name="N27" value="a"> Cuando te lo explican verbalmente<br>
            <input type="radio" name="N27" value="b"> Cuando utilizan medios visuales<br>  
            <input type="radio" name="N27" value="c"> Cuando se realiza a través de alguna actividad<br>  
    </div>

    <div class="pregresp">
            <h4>28. ¿Por qué te distingues?</h4><br>
            <input type="radio" name="N28" value="a"> Por tener una gran intuición<br>
            <input type="radio" name="N28" value="b"> Por ser un buen conversador<br>  
            <input type="radio" name="N28" value="c"> Por ser un buen observador<br>  
    </div>

    <div class="pregresp">
            <h4>29. ¿Qué es lo que más disfrutas de un amanecer?</h4><br>
            <input type="radio" name="N29" value="a"> La emoción de vivir un nuevo día<br>
            <input type="radio" name="N29" value="b"> Las tonalidades del cielo<br>  
            <input type="radio" name="N29" value="c"> El canto de las aves<br>  
    </div>

    <div class="pregresp">
            <h4>30. Si pudieras elegir ¿qué preferirías ser?v</h4><br>
            <input type="radio" name="N30" value="a"> Un gran médico<br>
            <input type="radio" name="N30" value="b"> Un gran músico<br>  
            <input type="radio" name="N30" value="c"> Un gran pintor<br>  
    </div>

    <div class="pregresp">
            <h4>31. Cuando eliges tu ropa, ¿qué es lo más importante para ti?</h4><br>
            <input type="radio" name="N31" value="a"> Que sea adecuada<br>
            <input type="radio" name="N31" value="b"> Que luzca bien<br>  
            <input type="radio" name="N31" value="c"> Que sea cómoda<br>  
    </div>

    <div class="pregresp">
            <h4>32. ¿Qué es lo que más disfrutas de una habitación?</h4><br>
            <input type="radio" name="N32" value="a"> Que sea silenciosa<br>
            <input type="radio" name="N32" value="b"> Que sea confortable<br>  
            <input type="radio" name="N32" value="c"> Que esté limpia y ordenada<br>  
    </div>

    <div class="pregresp">
            <h4>33. ¿Qué es más sexy para ti?</h4><br>
            <input type="radio" name="N33" value="a"> Una iluminación tenue<br>
            <input type="radio" name="N33" value="b"> El perfume<br>  
            <input type="radio" name="N33" value="c"> Cierto tipo de música<br>  
    </div>

    <div class="pregresp">
            <h4>34. ¿A qué tipo de espectáculo preferirías asistir?</h4><br>
            <input type="radio" name="N34" value="a"> A un concierto de música<br>
            <input type="radio" name="N34" value="b"> A un espectáculo de magia<br>  
            <input type="radio" name="N34" value="c"> A una muestra gastronómica<br>  
    </div>

    <div class="pregresp">
            <h4>35. ¿Qué te atrae más de una persona?</h4><br>
            <input type="radio" name="N35" value="a"> Su trato y forma de ser<br>
            <input type="radio" name="N35" value="b"> Su aspecto físico<br>  
            <input type="radio" name="N35" value="c"> Su conversación<br>  
    </div>

    <div class="pregresp">
            <h4>36. Cuando vas de compras, ¿en dónde pasas mucho tiempo?</h4><br>
            <input type="radio" name="N36" value="a"> En una librería<br>
            <input type="radio" name="N36" value="b"> En una perfumería<br>  
            <input type="radio" name="N36" value="c"> En una tienda de discos<br>  
    </div>

    <div class="pregresp">
            <h4>37. ¿Cuáles tu idea de una noche romántica?</h4><br>
            <input type="radio" name="N37" value="a"> A la luz de las velas<br>
            <input type="radio" name="N37" value="b"> Con música romántica<br>  
            <input type="radio" name="N37" value="c"> Bailando tranquilamente<br>  
    </div>

    <div class="pregresp">
            <h4>38. ¿Qué es lo que más disfrutas de viajar?</h4><br>
            <input type="radio" name="N38" value="a"> Conocer personas y hacer nuevos amigos<br>
            <input type="radio" name="N38" value="b"> Conocer lugares nuevos<br>  
            <input type="radio" name="N38" value="c"> Aprender sobre otras costumbres<br>  
    </div>

    <div class="pregresp">
            <h4>39. Cuando estás en la ciudad, ¿qué es lo que más hechas de menos del campo?</h4><br>
            <input type="radio" name="N39" value="a"> El aire limpio y refrescante<br>
            <input type="radio" name="N39" value="b"> Los paisajes<br>  
            <input type="radio" name="N39" value="c"> La tranquilidad<br>  
    </div>

    <div class="pregresp">
            <h4>40. Si te ofrecieran uno de los siguientes empleos, ¿cuál elegirías?</h4><br>
            <input type="radio" name="N40" value="a"> Director de una estación de radio<br>
            <input type="radio" name="N40" value="b"> Director de un club deportivo<br>  
            <input type="radio" name="N40" value="c"> Director de una revista<br>  
    </div>
                  <h4><center>
